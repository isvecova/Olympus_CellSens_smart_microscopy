...
IMAGE_PATH = Path(r"N:\02_instrument_management\SpinSR10\260827_AppData_cellSens_config\MK_muscle_focus_map\muscle_overview_01.vsi")

MODEL_PATH = Path(
    r"D:\OneDrive - IEM\000_inbox\260829_pixel_segmentation_napari\napari_models\v3_RF_normalized_background_to_muscle_peak.joblib"
)

MASK_OUTPUT = Path(r"N:\02_instrument_management\SpinSR10\260827_AppData_cellSens_config\260909\processed_mixed_2\v1_mask.tif")
...
POSITIONS_OUTPUT = Path(r"N:\02_instrument_management\SpinSR10\260827_AppData_cellSens_config\260909\processed_mixed_2\v1_pixel_classifier_positions.csv")
...
CELLSENS_TEMPLATE_PATH = Path(r"C:\path\to\your_cellsens_template.xml")
CELLSENS_OUTPUT = Path(r"N:\02_instrument_management\SpinSR10\260827_AppData_cellSens_config\260909\processed_mixed_2\v1_after_pixel_classifier_mixed.xml")
...
OVERVIEW_PIXEL_SIZE_X_UM = 0.65
OVERVIEW_PIXEL_SIZE_Y_UM = 0.65
